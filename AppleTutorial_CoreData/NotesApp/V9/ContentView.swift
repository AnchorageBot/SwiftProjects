...
existing notes. It also now includes a button to access the GlossaryView.
*/
...
/// This view displays a list of notes and allows for adding new notes, deleting existing ones, and accessing the glossary.
struct ContentView: View {
    ...
    /// State variable to control the presentation of the glossary view
