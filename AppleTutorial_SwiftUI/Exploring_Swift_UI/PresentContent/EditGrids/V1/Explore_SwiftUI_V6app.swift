...
struct Explore_SwiftUI_V6App: App {
    ...
    var body: some Scene {
        ...
        WindowGroup {
            ...
            /*
             When you create a new app, ContentView is configured as your top-level view by default.
             This is useful because you can go to ContentView to see how an app’s views are put together
             */
            ContentView()
