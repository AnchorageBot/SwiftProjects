...
struct ContentView: View {
    ...
    // Dice appearance settings
    let diceColor = Color(#colorLiteral(red: 0.9, green: 0.1, blue: 0.1, alpha: 1))
        ...
        ZStack {
            ...
            RadialGradient(
                gradient: Gradient(colors: [
                    Color(#colorLiteral(red: 0.24, green: 0.24, blue: 0.32, alpha: 1)),
            ...
            VStack {
                ...
                ZStack {
                    ...
                    // Our refined 3D dice implementation with correct perspective
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
            ...
            Timer.scheduledTimer(withTimeInterval: changeInterval, repeats: true) { timer in
                ...
                if timeElapsed >= rollDuration {
                    ...
                    // 3. Final slight bounce animation at the end
                    withAnimation(.spring(response: 0.3, dampingFraction: 0.4)) {
                        diceScale = 1.05 // Slightly larger than normal
                    }
