...
struct UntilProcessingCompleteFilter<Base>: AsyncSequence,
    ...
    /Users/ATS/Desktop/Engineering/Apple_VisionOS/ScanningObjectsUsingObjectCapture/GuidedCapture/UntilProcessingCompleteFilter.swift    func makeAsyncIterator() -> UntilProcessingCompleteFilter {
        return self
    }
