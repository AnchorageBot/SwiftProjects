...
/*
Abstract:
This file defines the PriceHistory class for the Grocery List app version 6.
...
- Utility methods for price comparison and formatting
- Computed properties for formatted price and date strings
*/
...
final class PriceHistory {
    ...
    /// Determines if this price is higher than another PriceHistory entry
    /// - Parameter other: Another PriceHistory entry to compare with
    /// - Returns: A Boolean indicating if this price is higher
    func isHigherThan(_ other: PriceHistory) -> Bool {
        return self.price > other.price
    }
    
    /// Determines if this price is lower than another PriceHistory entry
    /// - Parameter other: Another PriceHistory entry to compare with
    /// - Returns: A Boolean indicating if this price is lower
    func isLowerThan(_ other: PriceHistory) -> Bool {
        return self.price < other.price
    }
}
