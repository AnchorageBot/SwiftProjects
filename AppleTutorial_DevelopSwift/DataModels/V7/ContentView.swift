...
/*
 ...
 The content view now includes the capability to delete friend entries and a note
 to inform the user about swiping left to delete an entry.
...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            // Display a note to inform the user about swiping left to delete an entry
            .toolbar {
